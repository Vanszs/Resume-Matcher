    ...
    >
      <div className="w-full max-w-4xl border border-black bg-[#F0F0E8] shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)]">
        ...
        <div className="border-b border-black p-8 bg-white flex justify-between items-start">
          <div>
            <h1 className="font-serif text-3xl font-bold tracking-tight uppercase">Admin Panel</h1>
          ...
          {status !== 'error' && (
            <section className="space-y-4">
              <div className="flex items-center justify-between border-b border-black/10 pb-2">
                ...
                >
                  {showAddUser ? <XCircle className="w-4 h-4" /> : <UserPlus className="w-4 h-4" />}
          ...
          {status !== 'error' && (
            <section className="space-y-4">
              <div className="flex items-center gap-2 border-b border-black/10 pb-2">
                ...
                <h2 className="font-mono text-sm font-bold uppercase tracking-wider">Roles</h2>
              </div>
