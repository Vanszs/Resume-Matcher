...
app.add_middleware(
    ...
    allow_methods=["*"],
    allow_headers=["*"],
    expose_headers=["X-User-Id"],  # Allow frontend to read custom headers from 403 responses
)
...
app.include_router(resume_preview_router, prefix="/api/v1")
